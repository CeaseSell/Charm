...
function setupMoteTracker() {
    ...
    bellyDiv.innerHTML = `
        <div class="goal-bar" style="justify-content: center;">
            <div class="goal-section">
                <label for="motesGoal">Goal:</label>
                <input type="number" id="motesGoal" value="" min="0" class="number-box" style="text-align:center;">
            </div>
            <h2 class="goal-title" style="margin-left: 20px;">Event Rewards</h2>
            <div class="goal-section" style="margin-left: auto;">
            ...
            rewardDiv.addEventListener("click", function () {
                ...
                quantityInput.addEventListener("input", function () {
                    if (quantityInput.value !== "") {
                        ...
                        reward.limit -= quantity;
                        rewardDiv.querySelector(".reward-limit").textContent = `Limit: ${reward.limit}`;
                        updateMotes();
                    }
                });
            });
